  ...
  return (
    <div>
      <nav className="flex justify-between bg-[rgba(0,0,0,0.2)] w-screen h-14 fixed z-10">
        <div>
          <div className= {buttonState? "bg-[rgba(250,250,250,0.2)] circular-contact-menu": "bg-[rgba(0,0,0,0.2)] open-circular-contact-menu"}>
            ...
            <label>
              <p className="absolute text-2xl text-[rgba(0,0,0,0.5)] ml-[60%] mt-[-15%] text-glow" onClick={handleAtButton}><i className="fa-solid fa-at"></i></p>
              <span className="absolute bg-[rgba(255,255,255,0.5)] px-1 text-xs rounded-md ml-[15%] mt-[2%] visible" ><em>kotsugua@gmail.com</em></span>
              <span className={alertActive? "copied-alert-true":"copied-alert-false"}><em>copiado al portapapeles</em></span>
            </label>


            <label>
              <p className="absolute text-2xl text-[rgba(0,0,0,0.5)] ml-[50%] mt-[5%] text-glow"><a href="https://github.com/vhalzim"><i className="fa-brands fa-github"></i></a></p>
            ...
            <p className="absolute text-2xl text-[rgba(0,0,0,0.5)] ml-[30%] mt-[22%] text-glow"><a href="https://wa.me/5493584335701"><i class="fa-brands fa-whatsapp"></i></a></p>

            <p className="absolute text-2xl text-[rgba(0,0,0,0.5)] ml-[5%] mt-[35%] text-glow"><a href="https://t.me/VhalZim"><i class="fa-brands fa-telegram"></i></a></p>
          </div>
      ...
      <div className={dropdownActive? "fixed right-[2%] top-14 dropdown-on": "fixed right-[2%] top-14 dropdown-off"}>
          <button className="border-x bordder-b border-[#ff9000] px-3 hover:bg-[rgba(255,144,0,0.2)]" onClick ={()=>{alert("español")}}>Español</button><br/>
          <button className="border border-[#ff9000] rounded-b-md px-3 hover:bg-[rgba(255,144,0,0.2)]" onClick ={()=>{alert("english")}}>English</button>
        </div>
    </div>
